...
const config = {
    ...
    // We target a UMD and name it httpstatuscodes. When including the bundle in the browser it will be accessible at `window.httpstatuscodes`
    output: {
        path: resolvePath('dist-umd'),
        filename: '[name].js',
        libraryTarget: 'umd',
        library: 'httpstatuscodes',
        umdNamedDefine: true
    },
